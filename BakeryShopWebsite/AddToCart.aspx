<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddToCart.aspx.cs" Inherits="BakeryShopWebsite.AddToCart" %>
...
<body>
    ...
    <div align="center" style="margin:0 auto;">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            EmptyDataText="No Product Available in Cart" Height="257px" ShowFooter="True" 
            Width="1100px" onrowdeleting="GridView1_RowDeleting">
            <Columns>
        ...
        <asp:Button ID="Button1" runat="server" Text="Button" BackColor="#FF6699" 
            BorderColor="#65B9AA" BorderStyle="Ridge" Font-Bold="True" Font-Size="Large" 
