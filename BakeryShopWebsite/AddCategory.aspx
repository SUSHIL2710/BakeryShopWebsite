<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="BakeryShopWebsite.AddCategory" %>
    ...
    <div class="navbar" style="border-width:3px; border-color: #333333">
        <table align="center" style="width:386px; height:410px">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" Height="44px" Width="230px" CauseValidation="True" placeholder="Category Name" BorderColor="#333333"
                    Borderwidth="2px" Font-Bold="true" Font-Size="Medium"></asp:TextBox>
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Category Name" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                        ...
                        onrowupdating="GridView1_RowUpdating" PageSize="5" Width="257px">
                        <Columns>
